...
*/
func (a *applicationDependences) contextSetUser(r *http.Request, user *data.User) *http.Request {
...
func (a *applicationDependences) contextGetUser(r *http.Request) *data.User {
